...
<head>
  ...
  <title>Contact – Hungry Potter’s Tapsilogan</title>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .contact-hero-content .contact-btn {
    background: var(--clr-accent);
    color: #181f23;
    padding: .6rem 1.5rem;
    border-radius: .3rem;
  ...
  .contact-hero-content .contact-btn:hover {
    background: #fff;
    color: var(--clr-accent);
  }
  .contact-hero-map {
  ...
  @media (max-width: 900px) {
    ...
    .contact-hero-map { min-width: unset; }
...
<section class="contact-hero">
  <div class="contact-hero-content">
    ...
    <h1>Contact Hungry Potter’s</h1>
    <p>We love hearing from you! Whether you have questions, feedback, or just want to say hi, our team is here to help. Reach out via the form below, call us, or visit us in Makati City. We’ll get back to you as soon as possible!</p>
    <ul style="list-style:none; padding:0; margin:1rem 0 0 0;">
      <li><i class="fas fa-phone"></i> <b>+0956 802 7327</b></li>
      <li><i class="fas fa-envelope"></i> hungry@potter.com</li>
      <li><i class="fas fa-map-marker-alt"></i> <b>Makati City, Philippines</b></li>
      <li><i class="fas fa-clock"></i> Mon–Sun: 7:00 AM – 10:00 PM</li>
    </ul>
  </div>
  <div class="contact-hero-map">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3860.235964073812!2d121.0600462!3d14.5600274!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3397c988e0958e95%3A0xd8a8011daac21635!2sHungry%20Potter%20Kim's%20Tapsilogan!5e0!3m2!1sen!2sph!4v1719050000000!5m2!1sen!2sph" width="400" height="260" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
</section>
...
<section class="contact-section">
  <div class="contact-details">
    ...
    <ul>
      ...
      <li><i class="fas fa-envelope"></i> hungry@potter.com</li>
      <li><i class="fas fa-map-marker-alt"></i> Hungry Potter’s Kim's Tapsilogan, Makati City</li>
      <li><i class="fas fa-clock"></i> Mon–Sun: 7:00 AM – 10:00 PM</li>
    </ul>
    <p>Follow us on social media for updates, promos, and more food adventures!</p>
