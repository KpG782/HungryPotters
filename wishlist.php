...
<head>
  ...
  <title>Wishlist – Hungry Potter’s Tapsilogan</title>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .box .btn, .box .option-btn, .box .delete-btn {
    background: var(--clr-accent);
    color: #181f23;
    border: none;
    border-radius: .3rem;
  ...
  .box .btn:hover, .box .option-btn:hover, .box .delete-btn:hover {
    background: #fff;
    color: var(--clr-accent);
  }
  .empty {
  ...
  .wishlist-total .delete-btn.disabled {
    pointer-events: none;
    opacity: 0.5;
    background: #333;
    color: #888;
