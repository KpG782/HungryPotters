...
<head>
  ...
  <title>Cart – Hungry Potter’s Tapsilogan</title>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .products .heading, .products.shopping-cart .heading {
    font-family: var(--font-h);
    font-size: 2rem;
    text-align: center;
    text-transform: uppercase;
  ...
  .box .btn, .box button.fas.fa-edit, .box .delete-btn {
    background: var(--clr-accent);
    color: #181f23;
    border: none;
    border-radius: .3rem;
  ...
  .box .btn:hover, .box button.fas.fa-edit:hover, .box .delete-btn:hover {
    background: #fff;
    color: var(--clr-accent);
  }
  .box .fas.fa-eye {
  ...
  .cart-total .delete-btn.disabled, .cart-total .btn.disabled {
    pointer-events: none;
    opacity: 0.5;
    background: #333;
    color: #888;
