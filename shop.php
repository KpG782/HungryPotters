...
<head>
  ...
  <title>Menu – Hungry Potter’s Tapsilogan</title>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .hero {
    position: relative;
    height: 45vh;
    background: url('images/foods/wings and dips/wings and dip.jpg') center/cover no-repeat;
  ...
  .box .btn, .box button.fas.fa-heart {
    background: var(--clr-accent);
    color: #181f23;
    border: none;
    border-radius: .3rem;
  ...
  .box .btn:hover, .box button.fas.fa-heart:hover {
    background: #fff;
    color: var(--clr-accent);
  }
  .box .fas.fa-heart {
